export default {
    ...
    "cmd.vote.name": "Vote",
    "cmd.vote.description": "Vote for Chika",
    "cmd.vote.usage": "`vote` - gives you are link where you can vote",
    "cmd.vote.use": "Here is a link where you can vote and support Chika $link",
    "cmd.privacypolicy.name": "Privacy Policy",
    "cmd.privacypolicy.description": "displays you the Privacy Policy of Chika",
    "cmd.privacypolicy.usage": "`privacypolicy` - shows Privacy Policy",
    "cmd.anal.name": "anal",
