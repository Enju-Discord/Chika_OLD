export default {
    ...
    "cmd.someone.description": "randomly ping a user",
    "cmd.someone.usage": "`someone` - ping someone",
    "cmd.help.name": "help",
    ...
    "cmd.kitsune.description": "displays a kitsune image",
    "cmd.kitsune.usage": "`kitsune` - displays image",
    "cmd.kitsune.nsfw": "🚫 You can only use this command in an nsfw marked channel.",
    "cmd.neko.name": "neko",
    ...
    "cmd.trap.name": "trap",
    "cmd.trap.description": "displays a trap image",
    "cmd.trap.usage": "`trap` - displays image",
    "cmd.trap.nsfw": "🚫 You can only use this command in an nsfw marked channel.",
    "cmd.yuri.name": "trap",
    "cmd.yuri.description": "displays a yuri image",
    "cmd.yuri.usage": "`yuri` - displays image",
    "cmd.yuri.nsfw": "🚫 You can only use this command in an nsfw marked channel.",
    "cmd.ban.name": "ban",
    ...
    "cmd.unmute.notmuted": "$user is not mured.",
