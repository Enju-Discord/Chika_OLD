module.exports = {
    ...
    async execute(message, args, client, prefix) {
        const target = (message.channel.type === 'dm') ? message.author : (message.mentions.members.first().user || message.guild.members.cache.get(args[0]).user || message.member.user);
